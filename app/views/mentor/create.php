                ...
                <form method="POST" action="/mentor/create">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-text">
                                <?php if (isset($userRole) && $userRole === 'coach'): ?>
                                    This mentor will be automatically assigned to you.
                                <?php else: ?>
...
<?php if (isset($userRole) && $userRole === 'coach'): ?>
// For coaches, pre-populate the form with their church and coach
document.addEventListener('DOMContentLoaded', function() {
    // The church and coach are already pre-selected and non-editable
    console.log('Coach creating mentor - church and coach are pre-selected');
});
<?php endif; ?>
</script> 