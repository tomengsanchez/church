                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="pastor_id" name="pastor_id" required>
                                ...
                                <option value="<?= $pastor['id'] ?>" <?= $mentor['pastor_id'] == $pastor['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="coach_id" name="coach_id" required>
                                ...
                                <option value="<?= $coach['id'] ?>" <?= $mentor['coach_id'] == $coach['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="specialization" name="specialization" 
                                   value="<?= htmlspecialchars($mentor['specialization']) ?>" placeholder="e.g., Youth Ministry, Counseling">
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="experience_years" class="form-label">Years of Experience</label>
                            <input type="number" class="form-control" id="experience_years" name="experience_years" 
                                   value="<?= htmlspecialchars($mentor['experience_years']) ?>" min="0" max="50">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" 
                                   value="<?= htmlspecialchars($mentor['date_of_birth']) ?>">
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="joining_date" class="form-label">Joining Date</label>
                            <input type="date" class="form-control" id="joining_date" name="joining_date" 
                                   value="<?= htmlspecialchars($mentor['joining_date']) ?>">
                        </div>
                    </div>
