...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="/events/church/create" class="btn btn-primary">
                <i class="fas fa-plus me-2"></i>Add Church Event
            </a>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="/events/church/view/<?= $event['id'] ?>" class="btn btn-outline-primary btn-sm" title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="/events/church/edit/<?= $event['id'] ?>" class="btn btn-outline-secondary btn-sm" title="Edit">
                ...
                <div class="text-center py-5">
                    ...
                    <h4 class="text-muted">No Church Events Found</h4>
                    <p class="text-muted">Start by adding your first church event.</p>
                    <a href="/events/church/create" class="btn btn-primary">
                        <i class="fas fa-plus me-2"></i>Add Church Event
                    </a>
                </div>
