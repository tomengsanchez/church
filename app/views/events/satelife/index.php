        ...
        <div class="card">
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="/events/satelife/view/<?= $event['id'] ?>" class="btn btn-outline-primary btn-sm" title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="/events/satelife/edit/<?= $event['id'] ?>" class="btn btn-outline-secondary btn-sm" title="Edit">
                ...
                <div class="text-center py-5">
                    ...
                    <h4 class="text-muted">No Satelife Events Found</h4>
                    <p class="text-muted">Start by adding your first satelife event.</p>
                    <a href="/events/satelife/create" class="btn btn-primary">
                        <i class="fas fa-plus me-2"></i>Add Satelife Event
                    </a>
                </div>
